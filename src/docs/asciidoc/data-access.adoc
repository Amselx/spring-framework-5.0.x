...
com.kam.config.Config like in the following example.
...
`EmbeddedDatabaseBuilder` for Java com.kam.config.Config) will set the name of the embedded database to
