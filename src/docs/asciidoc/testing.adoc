...
declares a `static` nested configuration class named `com.kam.config.Config` that will be automatically
...
----
	...
	// static nested com.kam.config.Config class
	**@ContextConfiguration**
	public class OrderServiceTest {

		@Configuration
		static class com.kam.config.Config {
