...
When using annotation-driven components or Java com.kam.config.Config, the `@RequestScope` annotation
...
When using annotation-driven components or Java com.kam.config.Config, the `@SessionScope` annotation
...
When using annotation-driven components or Java com.kam.config.Config, the `@ApplicationScope`
...
`Bean(Factory)com.kam.PostProcessor`, that post-processor will not get instantiated at all.
Thus, marking it for lazy initialization will be ignored, and the
`Bean(Factory)com.kam.PostProcessor` will be instantiated eagerly even if you set the
