...
/**
 * GenericApplicationContext首先构造工厂DefaultListableBeanFactory，拥有了存放bd的容器
 * GenericApplicationContext实现BeanDefinitionRegistry，故可以注册bd到工厂类似操作。
 * GenericApplicationContext注册bd调用DefaultListableBeanFactory中的注册方法
 *
 ...
 *
 *
 * Bean工厂存在于这个类中，并且复写了DefaultListableBeanFactory的getBeanFacotry()方法使得这个类有能力获得beanFactory
 */
public class GenericApplicationContext extends AbstractApplicationContext implements BeanDefinitionRegistry {
	...
	public GenericApplicationContext() {
		//实例化DefaultListableBeanFacotry这个Bean工厂
